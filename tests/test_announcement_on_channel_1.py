...
def test_explicit_config_channel_1():
    ...
    print(f"  ✓ Announcement channel is channel_idx=1")
    print(f"  ✓ Announcements will go to #weather channel (channel 1)")
    print()
...
def test_auto_detect_channel_1():
    ...
    print(f"  ✓ Auto-detected #weather channel on channel 1")
    print(f"  ✓ Future announcements will go to channel 1")
    print()
...
def test_hashtag_detection_channel_1():
    ...
    print(f"  → Auto-detected #weather channel on channel_idx=1")
    print(f"  → _announce_channel_idx: {bot._announce_channel_idx}")
...
def test_no_interference_from_other_channels():
    ...
    for ch in [0, 2, 3, 4]:
        ...
        assert location is None, f"Should not detect location in greeting"
    ...
    print(f"  ✓ Other channels did NOT interfere")
    print()
