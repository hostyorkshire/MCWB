...
def test_announcement_on_recent_restart():
    ...
    print("  Simulated last announcement: 1 hour ago")
    ...
    print("  ✓ Announcement will be sent (always announces on reboot)")
    ...
    print("  ✓ Bot announces on startup regardless of interval")
...
def test_announcement_on_old_restart():
    ...
    print("  ✓ Announcement will be sent (8 hours > 6 hours)")
...
def test_announcement_on_first_start():
    ...
    bot = WeatherBot(node_id="test_bot", debug=False, announce=True, weather_channel_idx=1)
    print("  No previous announcement file exists")
