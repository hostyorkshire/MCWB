...
def test_channel_reply_behavior():
    ...
    msg1 = MeshCoreMessage(sender="User1", content="wx test", message_type="text", channel=None, channel_idx=0)
    ...
    if len(processed) > 0:
        ...
        if len(sent_messages) > 0 and sent_messages[0]["channel_idx"] == 0:
            ...
            print(
                f"❌ FAIL: Bot did not reply on channel_idx 0 (got: {sent_messages[0] if sent_messages else 'no message'})\n"
            )
            return False
    else:
    ...
    msg2 = MeshCoreMessage(sender="User2", content="wx test", message_type="text", channel=None, channel_idx=1)
    ...
    msg3 = MeshCoreMessage(sender="User3", content="wx test", message_type="text", channel="weather", channel_idx=1)
