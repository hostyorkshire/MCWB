...
def test_multi_channel_responses():
    ...
    def mock_send(content, msg_type="text", channel=None, channel_idx=None):
        responses.append({"content": content, "channel": channel, "channel_idx": channel_idx})
    ...
    print("=" * 70)
    responses.clear()
    msg1 = MeshCoreMessage(sender="user1", content="wx London", message_type="text", channel=None, channel_idx=0)
    ...
    print("=" * 70)
    responses.clear()
    msg2 = MeshCoreMessage(sender="user2", content="wx Manchester", message_type="text", channel=None, channel_idx=1)
    ...
    print("=" * 70)
    responses.clear()
    msg3 = MeshCoreMessage(sender="user3", content="wx York", message_type="text", channel=None, channel_idx=2)
