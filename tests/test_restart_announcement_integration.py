...
def test_complete_restart_scenario():
    ...
    print(f"  ✓ First startup announcement sent to channel_idx=0 (default)")
    ...
    print(f"  ✓ Bot detected #weather on channel_idx=1")
    ...
    print(f"  ✓ Bot loaded persisted channel: channel_idx=1")
    print(f"  ✓ Startup announcement sent to channel_idx=1 (#weather)")
