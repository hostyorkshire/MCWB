...
**Changed in `public_html/wx/js/dashboard.js` and `public_html/wx/index.html`:**
...
4. `public_html/wx/js/dashboard.js` - Static site JS updates
5. `public_html/wx/index.html` - Static site HTML updates
